...
from design_system import generate_design_system, persist_design_system, slugify_path_component
...
if __name__ == "__main__":
    ...
    if args.design_system:
        ...
        if args.persist:
            project_slug = slugify_path_component(args.project_name or args.query, "project name")
            print("\n" + "=" * 60)
            print(f"✅ Design system persisted to design-system/{project_slug}/")
            print(f"   📄 design-system/{project_slug}/MASTER.md (Global Source of Truth)")
            if args.page:
                page_filename = slugify_path_component(args.page, "page name")
