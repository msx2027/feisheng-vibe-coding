 ...
 *
 * For full color extraction from images, use ImageMagick
 * or another local image analysis tool.
 *
 * Usage:
 ...
 *   or another local tool that can export dominant hex colors
...
function main() {
  ...
  const result = {
    ...
    instructions: [
      ...
      "",
      "2. If ImageMagick is unavailable, use any local image analysis tool",
      "   that can export the 10 most dominant colors as hex values.",
      "",
