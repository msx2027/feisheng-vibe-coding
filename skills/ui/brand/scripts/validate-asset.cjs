 ...
 * validate-asset.cjs
 *
 * Validates brand assets against brand guidelines.
...
function main() {
  ...
  if (!assetPath) {
    ...
    console.error("\nExamples:");
    console.error(
      "  node validate-asset.cjs assets/screens/design_dashboard-overview_20251209.png"
    );
    console.error(
      "  node validate-asset.cjs assets/logos/logo_brand-refresh_icon_20251209.svg --json"
    );
    process.exit(1);
  }
